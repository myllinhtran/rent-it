...
const ReactImageUploadComponent = function (_React$Component) {
  ...
  function ReactImageUploadComponent(props) {
    ...
    const _this = _possibleConstructorReturn(this, (ReactImageUploadComponent.__proto__ || Object.getPrototypeOf(ReactImageUploadComponent)).call(this, props));
  ...
  _createClass(ReactImageUploadComponent, [{
    ...
    */
    ...
    value: function removeImage(picture) {
      ...
      const removeIndex = this.state.pictures.findIndex(function (e) {
        return e === picture;
      });
      const filteredPictures = this.state.pictures.filter(function (e, index) {
        return index !== removeIndex;
      });
      const filteredFiles = this.state.files.filter(function (e, index) {
        return index !== removeIndex;
      });
